...
* 更新前の原本は破棄せず、`docs/P001-requirement_{YYYYMMDD}.md` としてリネームして保持する。
...
* `docs/P001-requirement_{YYYYMMDD}.md` (更新前の原本)

### アウトプットの記載内容

* 更新前の `docs/P001-requirement.md` を `docs/P001-requirement_{YYYYMMDD}.md` にコピーしてから、`docs/P001-requirement.md` 本体を更新する。
