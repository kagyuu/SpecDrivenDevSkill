...
* [`server/INDEX.md`](./server/INDEX.md) — バックエンド(Starlette + Pydantic 2 + SQLite、ADR-002のFastAPI代替)。API実装・Repository/Service層・単体テスト159件の目次(CR-002対応で121件→134件、CR-003対応で134件→159件)。
* [`client/INDEX.md`](./client/INDEX.md) — フロントエンド(プレーンHTML/CSS/JavaScript、ADR-001のReact+TS+Vite代替)。画面(S01〜S07)実装・単体テスト57件の目次(CR-001対応で35件→38件、CR-002対応で38件→45件、CR-003対応で45件→57件)。
...
* [`docs/P007-impl-direction.md`](./docs/P007-impl-direction.md) — プログラム実装定義(目次、U001〜U007。U005はCR-001対応、U006はCR-002対応、U007はCR-003対応で追加)
* [`docs/P008-test-direction.md`](./docs/P008-test-direction.md) — 結合テスト定義(目次、T001〜T028。T021〜T023はCR-002対応、T024〜T028はCR-003対応で追加、全PASS)
...
* [`docs/P202-fix-plan.md`](./docs/P202-fix-plan.md) — 修正計画書(目次、F001〜F004、全解決済み。F004はCR-002処理中に検出)
...
* [`docs/ADR.md`](./docs/ADR.md) — 現在有効な設計判断(ADR-001〜ADR-008。ADR-008はCR-003のP905で追加)

## 修正計画の詳細(P202-fix-plan/)

* [`docs/P202-fix-plan/P202-fix-resolved.md`](./docs/P202-fix-plan/P202-fix-resolved.md) — 解決済み修正障害一覧(F001〜F004、全件RESOLVED)
...
* [`docs/test-records/20260803-2010-cr002-test-record.md`](./docs/test-records/20260803-2010-cr002-test-record.md) — Refactor(P903、CR-002対応)結合テスト初回実行記録(T021 PASS、T022・T023 FAIL)
* [`docs/test-records/20260803-2050-cr002-retest-record.md`](./docs/test-records/20260803-2050-cr002-retest-record.md) — CR-002 F004修正後の再テスト記録(T022・T023 PASS、全134+45件回帰なし)
* [`docs/test-records/20260804-1520-cr003-test-record.md`](./docs/test-records/20260804-1520-cr003-test-record.md) — Refactor(P903、CR-003対応)結合テスト実行記録(T024〜T028 全PASS、全159+57件回帰なし。初期化処理の2回連続実行による再起動耐性の実測を含む)
...
* [`docs/cr-records/CR-002.md`](./docs/cr-records/CR-002.md) — 対応完了したCRの記録(会議室説明文(description)追加、2026-08-03完了)。
* [`docs/cr-records/CR-003.md`](./docs/cr-records/CR-003.md) — 対応完了したCRの記録(予約の参加予定人数(attendee_count)追加、2026-08-04完了)。
