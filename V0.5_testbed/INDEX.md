...
* [`server/INDEX.md`](./server/INDEX.md) — バックエンド(Starlette + Pydantic 2 + SQLite、ADR-002のFastAPI代替)。API実装・Repository/Service層・単体テスト134件の目次(CR-002対応で121件→134件)。
* [`client/INDEX.md`](./client/INDEX.md) — フロントエンド(プレーンHTML/CSS/JavaScript、ADR-001のReact+TS+Vite代替)。画面(S01〜S07)実装・単体テスト45件の目次(CR-001対応で35件→38件、CR-002対応で38件→45件)。
...
* [`docs/P007-impl-direction.md`](./docs/P007-impl-direction.md) — プログラム実装定義(目次、U001〜U006。U005はCR-001対応、U006はCR-002対応で追加)
* [`docs/P008-test-direction.md`](./docs/P008-test-direction.md) — 結合テスト定義(目次、T001〜T023。T021〜T023はCR-002対応で追加、全PASS)
